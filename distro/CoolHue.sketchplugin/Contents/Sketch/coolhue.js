...
/*!*************************!*\
  !*** ./src/gradient.js ***!
  \*************************/
/*! exports provided: GradientMaker */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "GradientMaker", function() { return GradientMaker; });
...
function GradientMaker(firstStop, secondStop) {
  ...
  if (selectedLayers.length != null && selectedLayers.length != 0) {
    selectedLayers.forEach(function (layer) {
      if (layer.type === "Shape" || layer.type === "ShapePath") {
        ...
        sketch_ui__WEBPACK_IMPORTED_MODULE_1___default.a.message("\uD83D\uDD14 CoolHue can apply gradients on Shape Layer(s) only");
      }
    });
  } else {
    sketch_ui__WEBPACK_IMPORTED_MODULE_1___default.a.message("\uD83D\uDED1 Select Shape Layer(s) to apply CoolHue Gradients");
  }
}
...
//# sourceMappingURL=coolhue.js.map